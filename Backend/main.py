...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Allow all origins. You can restrict it by specifying domains like ["http://localhost:3000"]
...
# Define a request model to validate input text
class TextRequest(BaseModel):
    text: str

# Default route to verify the API is working
@app.get('/')
def root():
